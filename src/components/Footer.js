          ...
          <div className='row'>
            ...
            <div className='col-3'>
              ...
              <div className='footer-links d-flex flex-column'>
                <Link to='/privacy-policy' className='text-white py-2 '>Privacy Policy</Link>
                <Link to='/refund-policy' className='text-white py-2 '>Refund Policy</Link>
                <Link to='/terms-conditions' className='text-white py-2 '>Terms of Service</Link>
                <Link to='/blogs' className='text-white py-2 '>Blogs</Link>
                <Link to='/shipping-policy' className='text-white py-2 '>Shipping Policy</Link>
              </div>
            </div>
            <div className='col-3'>
